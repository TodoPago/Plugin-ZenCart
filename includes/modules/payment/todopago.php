...
class todopago extends base
{
    ...
    private $tplogger, $todoPagoConfig, $todopagoTransaccion, $mantenerCarrito,$params;
    ...
    private function call_sar($connector, $http_header, $paramsSAR)
    {
        ...
        $this->setMantenerCarrito($resultConfig->fields['keep_shopping_cart']);
    ...
    function install()
    {
        ...
        $db->Execute("INSERT INTO `".TABLE_TP_CONFIGURACION."` (`idConf`, `authorization`, `segmento`, `canal`, `ambiente`, `deadline`, `test_merchant`, `test_security`, `production_merchant`, `production_security`, `estado_inicio`, `estado_aprobada`, `estado_rechazada`, `tipo_formulario`, `estado_offline`, `keep_shopping_cart`) VALUES ('1', '', '', '', '', '', '', '', '', '', '', '', '', '0', '', '1')");
